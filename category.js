...
Thank you.`;
    ...
    if (catKey === 'oncology-drugs' || catKey === 'anaesthesia' || catKey === 'analgesic-antipyretic' || catKey === 'anti-malaria' || catKey === 'antibiotics' || catKey === 'antidiabetic' || catKey === 'antifungal' || catKey === 'antipsychotic' || catKey === 'antiviral' || catKey === 'cardiovascular-drugs' || catKey === 'dermatology-drugs' || catKey === 'gastro-intestinal' || catKey === 'general-medicine' || catKey === 'gynaec' || catKey === 'health-supplement' || catKey === 'herbal' || catKey === 'men-health' || catKey === 'neurology' || catKey === 'orthopaedic-rehabilitation' || catKey === 'respiratory-drugs' || catKey === 'veterinary-products') {
        ...
        window.openProductDetailsModal = (productName) => {
            ...
            const packLabel = document.getElementById('onc-modal-pack-label');
            if (catKey === 'orthopaedic-rehabilitation') {
                ...
                if (packLabel) packLabel.textContent = 'Available Pack Sizes';
            }
    ...
    const renderFilterCheckboxes = () => {
        ...
        if (pkgMobileSection) {
            pkgMobileSection.style.display = (catKey === 'antiviral' || catKey === 'cardiovascular-drugs' || catKey === 'dermatology-drugs' || catKey === 'gastro-intestinal' || catKey === 'general-medicine' || catKey === 'gynaec' || catKey === 'health-supplement' || catKey === 'herbal' || catKey === 'men-health' || catKey === 'neurology' || catKey === 'respiratory-drugs' || catKey === 'veterinary-products') ? 'none' : 'block';
        }
